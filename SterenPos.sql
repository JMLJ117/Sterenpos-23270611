...
ALTER TABLE `SterenPOS`.`Ventas` 
MODIFY COLUMN `IVA` DECIMAL(12,2) GENERATED ALWAYS AS (`Subtotal` * 0.16) STORED;
-- -----------------------------------------------------
...
-- Electrónica (CategoríaID 1)
('7501000000006', 'Multímetro Digital', 'Multímetro profesional 6000 conteos', 499.00, 250.00, 50, 1, 1, 1),
('7501000000013', 'Fuente de poder 12V', 'Fuente regulada 12V 2A', 299.00, 120.00, 60, 1, 1, 1),
('7501000000020', 'Termómetro digital', 'Para soldadores y equipos electrónicos', 249.00, 100.00, 70, 1, 1, 1),
('7501000000037', 'Cámara IP 1080p', 'Conexión PoE, visión nocturna', 899.00, 400.00, 25, 1, 1, 1),

-- Herramientas (CategoríaID 2)
('7502000000005', 'Juego de Destornilladores', '6 piezas con mangos anti-deslizantes', 199.50, 80.00, 100, 2, 2, 2),
('7502000000012', 'Soldador de precisión', 'Soldador con temperatura ajustable 200-450°C', 349.99, 150.00, 80, 1, 2, 1),
('7502000000029', 'Cortadores de alambre', 'Juego de 3 cortadores de cobre', 149.50, 60.00, 120, 2, 2, 2),
('7502000000036', 'Multitool 10 piezas', 'Herramientas en una sola unidad', 199.00, 85.00, 90, 2, 2, 2),
('7502000000043', 'Caja de herramientas', '60 piezas, acero al carbono', 599.00, 250.00, 40, 1, 2, 1),
('7502000000050', 'Destornillador eléctrico', 'Con 10 puntas intercambiables', 429.50, 180.00, 30, 1, 2, 1),
('7502000000067', 'Kit de soldadura', 'Soldador + pasta conductiva', 399.00, 160.00, 50, 1, 2, 1),
('7502000000074', 'Pinza de punta fina', '8", mango ergonómico', 99.00, 40.00, 110, 2, 2, 2),
('7502000000081', 'Caja de fusibles', '20 unidades, 250V', 89.50, 35.00, 90, 2, 2, 2),
('7502000000098', 'Estación de trabajo', 'Soldador + extractor de aire', 749.00, 320.00, 20, 1, 2, 1),
('7502000000104', 'Lupa LED', '8x de aumento con luz', 149.00, 60.00, 75, 2, 2, 2),
('7502000000111', 'Tester de cables', 'Verifica RJ45/RJ11', 299.00, 120.00, 45, 1, 2, 1),

-- Conectores (CategoríaID 3)
('7503000000001', 'Cable HDMI 2m', 'Versión 2.1, oro 24k', 129.99, 50.00, 200, 2, 3, 2),
('7503000000018', 'Cable USB-C a USB-C', '2m, 100W, carga rápida', 89.99, 35.00, 150, 2, 3, 2),
('7503000000025', 'Cable coaxial RG6', '50m, blindado doble', 199.00, 75.00, 100, 2, 3, 2),
('7503000000032', 'Adaptador VGA-HDMI', 'Convertidor activo con alimentación', 179.00, 70.00, 65, 1, 3, 1),
('7503000000049', 'Cable de red Cat6', '3m, blindado SFTP', 79.99, 30.00, 180, 2, 3, 2),
('7503000000056', 'Cable DisplayPort', '1.4, 8K, 2m', 199.00, 80.00, 90, 1, 3, 1);
